...
<header class="bg-gray-900 text-white py-6 px-6 text-center shadow-md">
  <h1 class="font-display text-3xl font-bold mb-2 tracking-tight flex items-center justify-center gap-2">
