...
- **Multiple accounts** - Credit cards, savings, super, investments across institutions
...
"How does my spending compare to the average Australian?"
...
- 📥 **Multi-Bank Import** - ANZ, Vanguard, AustralianSuper, and more
- 💬 **AI Financial Advisor** - Conversational insights via Valet LLM
- 📊 **Spending Analysis** - Category breakdown, trends, comparisons
- 🏦 **Retirement Planning** - Superannuation projections, 4% rule, preservation age
...
flowchart TB
    subgraph Import["Data Import"]
        F[CSV/PDF Files]
        P[Parsers<br/>ANZ, Vanguard, Super]
    end
    ...
    subgraph Backend["Backend"]
        ...
        K[Knowledge Base<br/>Australian Finance]
    end
...
| Institution | Format | Data Type |
|-------------|--------|-----------|
| **ANZ Credit Card** | CSV | Transactions |
| **ANZ Savings** | CSV | Transactions |
| **AustralianSuper** | CSV | Super contributions, balance |
| **Vanguard** | CSV | Investment holdings |
| **ANZ Plus** | PDF | Coming soon |
...
- Private health insurance tracking
- Medicare Levy Surcharge impact
- Coverage analysis
...
The advisor is grounded in Australian financial knowledge:

- Superannuation rules and preservation ages
- Tax brackets and offsets
- Medicare Levy and MLS thresholds
...
4. **Knowledge grounding works** - Injecting Australian finance rules prevents hallucinations
